...
export const routes = [
    ...
    { path: '/ws', component: () => import('./views/durable-objects.vue'), meta: { title: 'Durable Objects', description: 'Unofficial Cloudflare Durable Objects™ pricing calculator', logo: 'Durable Object' } },
]
